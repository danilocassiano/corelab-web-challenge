...
const CreateNote = () => {
  ...
  return (
    <div className="relative inset-0 flex items-start justify-center p-4 md:items-start">
      <div className="bg-white border border-[#D9D9D9] rounded-[25px] max-w-[320px] w-full p-4 relative top-[10px] md:max-w-[500px] lg:max-w-[600px] md:top-[100px] lg:top-[20px] lg:rounded-none">
